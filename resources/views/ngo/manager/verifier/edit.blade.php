                            ...
                            <div class="row no-gutters">
                                <div class="col-xl-12">
                                    <div class="auth-form">
                                        ...
                                        <form method="POST" action="/ngo/manager/verifier/{{$verifier->id}}" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group">
                                                <label><strong>Name</strong></label>
                                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                                        value="{{ $verifier->name }}" required autocomplete="name">
                                                @error('name')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" 
                                                        value="{{ $verifier->email }}" required autocomplete="email">
                                                @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img src="{{asset('storage' . __('custom.verifierpath') .'/'. $verifier->profileimage)}}" 
