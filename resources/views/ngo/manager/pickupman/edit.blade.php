                    ...
                    <div class="col-md-9">
                        <div class="authincation-content">
                            <div class="row no-gutters">
                                <div class="col-xl-12">
                                    <div class="auth-form">
                                        <h4 class="text-center mb-4">Edit Pickupman</h4>
                                        @include('partial.customerror')
                                        @include('partial.success')
                                        <form method="POST" action="/ngo/manager/pickupmen/{{$pickupman->id}}" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group">
                                                <label><strong>Name</strong></label>
                                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                                        value="{{ $pickupman->name }}" required autocomplete="name">
                                                @error('name')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" 
                                                        value="{{ $pickupman->email }}" required autocomplete="email">
                                                @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="contact" class="form-control @error('contact') is-invalid @enderror" 
                                                        value="{{ $pickupman->contact }}" required autocomplete="contact">
                                                @error('contact')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img src="{{asset('storage' . __('custom.pickupmanpath') .'/'. $pickupman->profileimage)}}" 
