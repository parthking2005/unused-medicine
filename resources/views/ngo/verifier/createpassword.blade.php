...
<head>
    ...
    <title>Create Verifier Password</title>
    <!-- Favicon icon -->
                ...
                <div class="col-md-4">
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    <h4 class="text-center mb-4">Create Verifier Password</h4>
                                    @include('partial.customerror')
                                    @include('partial.success')
                                    <form method="POST" action="{{ route('Verifier-CreatePassword') }}">
                                        @csrf
                                        ...
                                        <div class="text-center mt-3">
                                            <a class="text-primary" href="{{ route('verifier-login') }}">Go to Verifier Login</a>
                                        </div>
                                    </form>
